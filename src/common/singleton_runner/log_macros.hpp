...
#define AU_LOG_DEBUG(...) \
    LOGGER->log_event(trustwave::logger::debug2, trustwave::logger::COLLECT_FROM_NONE, ERR_LOG, \
                      ::trustwave::LoggerSource::instance()->get_source(), __VA_ARGS__)
//        ::trustwave::LoggerSource::instance()->get_source_id(),

#define AU_LOG_DEBUG1(...) \
    LOGGER->log_event(trustwave::logger::debug1, trustwave::logger::COLLECT_FROM_NONE, ERR_LOG, \
                      ::trustwave::LoggerSource::instance()->get_source(), __VA_ARGS__)
//        ::trustwave::LoggerSource::instance()->get_source_id(),
...
#define AU_LOG_ERROR(...) \
    LOGGER->log_event(trustwave::logger::error, trustwave::logger::COLLECT_FROM_NONE, ERR_LOG, \
                      ::trustwave::LoggerSource::instance()->get_source(), __VA_ARGS__)
//         ::trustwave::LoggerSource::instance()->get_source_id(),

#define AU_LOG_WARNING(...) \
    LOGGER->log_event(trustwave::logger::warning, trustwave::logger::COLLECT_FROM_NONE, ERR_LOG, \
                      ::trustwave::LoggerSource::instance()->get_source(), __VA_ARGS__)
//         ::trustwave::LoggerSource::instance()->get_source_id(),

#define AU_LOG_ERRNO_DEBUG(...) \
    LOGGER->log_event(trustwave::logger::debug, trustwave::logger::COLLECT_FROM_ERNO, ERR_LOG, \
                      ::trustwave::LoggerSource::instance()->get_source(), __VA_ARGS__)
//         ::trustwave::LoggerSource::instance()->get_source_id(),

#define AU_LOG_ERRNO_INFO(...) \
    LOGGER->log_event(trustwave::logger::info, trustwave::logger::COLLECT_FROM_ERNO, ERR_LOG, \
                      ::trustwave::LoggerSource::instance()->get_source(), __VA_ARGS__)
//         ::trustwave::LoggerSource::instance()->get_source_id(),

#define AU_LOG_ERRNO_ERROR(...) \
