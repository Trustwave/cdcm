...
//=====================================================================================================================
namespace trustwave {
    template<typename Session_T> class inproc_in_sessions_cache {
    private:
    public:
        ...
        struct element {
            ...
            Session_T second;
            const boost::uuids::uuid& s_id() const { return second.id(); }
            const std::string& s_remote() const { return second.remote(); }
        };
