...
shared_mem_session_element::shared_mem_session_element(sp_session_t sp_session, size_t idle_timeout,
                ...
                expiration_time_(chr::system_clock::to_time_t(chr::system_clock::now()) + idle_timeout), session_(
                                session_converter::convert(sp_session, va))
{
}
