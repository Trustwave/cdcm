...
#define EnumDefineNames(typeName, values)  static std::array<const char *, number_of_##typeName> typeName##Array = {""}; \
namespace { \
...
#define SmartEnum(typeName)    \
EnumDefineEnum(typeName, typeName##_LIST)  \
EnumDefineNames(typeName, typeName##_LIST)
