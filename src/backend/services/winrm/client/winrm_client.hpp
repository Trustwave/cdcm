...
namespace trustwave {
    ...
    public:
        ...
        winrm_client(const std::string& host, const int port, const std::string& path, const std::string& scheme,
        ...
        void Enumerate(const std::string& resourceUri, WsmanFilter& filter, std::vector<std::string>& enumRes) const;
        void Enumerate(const std::string& resourceUri, std::vector<std::string>& enumRes, const WsmanOptions& options,
                       const WsmanFilter& filter) const;
        std::string Get(const std::string& resourceUri, const WsmanOptions& options) const;
        std::string Get(const std::string& resourceUri, const NameValuePairs* s) const;
