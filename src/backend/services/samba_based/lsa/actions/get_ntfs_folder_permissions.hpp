//=====================================================================================================================
// Trustwave ltd. @{SRCH}
//														get_ntfs_folder_permissions.hpp
//
//---------------------------------------------------------------------------------------------------------------------
// DESCRIPTION:
//
...
//                          						Include files
//=====================================================================================================================
#ifndef SRC_BACKEND_SERVICES_SAMBA_BASED_LSA_ACTIONS_GET_NTFS_FOLDER_PERMISSIONS_HPP
#define SRC_BACKEND_SERVICES_SAMBA_BASED_LSA_ACTIONS_GET_NTFS_FOLDER_PERMISSIONS_HPP
...
namespace trustwave {
    ...
    class Get_NTFS_Folder_Permissions_Action final: public Action_Base {
    public:
        Get_NTFS_Folder_Permissions_Action(): Action_Base(trustwave::lsa_action_get_ntfs_folder_permissions_msg::act_name) {}
        ...
        {
            return v.as<std::shared_ptr<trustwave::lsa_action_get_ntfs_folder_permissions_msg>>();
        }
    };

} // namespace trustwave

#endif // SRC_BACKEND_SERVICES_SAMBA_BASED_LSA_ACTIONS_GET_NTFS_FOLDER_PERMISSIONS_HPP