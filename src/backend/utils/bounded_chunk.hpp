...
namespace trustwave {
    ...
    public:
        ...
        [[nodiscard]] inline offset_type offset() const { return offset_; }

        [[nodiscard]] inline offset_type size() const { return end_ - offset_; }

        [[nodiscard]] inline offset_type end() const { return end_; }
...
namespace boost::icl {
    template<> struct interval_traits<trustwave::bounded_chunk> {
        ...
        static interval_type construct(const domain_type& lo, const domain_type& up) { return interval_type(lo, up); }
    ...
    template<> struct interval_bound_type<trustwave::bounded_chunk> {
